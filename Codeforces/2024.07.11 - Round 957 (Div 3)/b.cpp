...
Description of each test case consists of two lines. The first line contains two integers n and k (2≤n≤109, 2≤k≤105) — length of casserole and the number of pieces.

The second line contains k integers a1,a2,…,ak (1≤ai≤n−1, ∑ai=n) — lengths of pieces of casserole, which Noobish_Monk has cut.

It is guaranteed that the sum of k over all t test cases doesn't exceed 2⋅105.
...
int main()
{
    ...
    while (t--)
    {
        ...
        cout << totalOnes + breakDowns << endl;
    }
    return 0;
}